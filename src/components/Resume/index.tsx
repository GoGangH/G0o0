...
export default function Resume({ onClose }: ResumeProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 z-[100] overflow-auto">
      {/* Control Bar - Hidden in print */}
      <div className="print:hidden sticky top-0 bg-[#2d2d2d] border-b border-[#4a4a4a] p-4 flex justify-between items-center z-10">
      ...
      <div className="flex justify-center py-8 print:py-0">
        <div
          className="bg-white text-black w-[210mm] min-h-[297mm] p-[20mm] shadow-2xl print:shadow-none print:p-[15mm]"
          style={{ fontFamily: "system-ui, -apple-system, sans-serif" }}
        >
          {/* Page 1: Header + About + Career */}
          <div className="page-content">
            {/* Header Section */}
            <header className="flex gap-6 mb-6 pb-4 border-b-2 border-gray-200">
